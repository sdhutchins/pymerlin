...
readonly sacct_result_path="${results_directory}/pah_meiosis_ordering_${job_id}.sacct.tsv"
readonly seff_result_path="${results_directory}/pah_meiosis_ordering_${job_id}.seff.txt"
